about-attribution-title = Gracias.
...
about-ironfox-quote =
    ...
    <em>Zorro</em> crea una <em class="f">chispa</em>. Atraído por su <em class="f">luz</em>, un <em>Fénix</em> se fusionó
    con el zorro <em>Fox</em> para formar una cobertura de <em>Acero</em>. Con esa nueva <em class="f">fuerza</em>, la
    criatura se levanta para <em class="f">vengar</em> al <em>Topo</em> y a la <em>Bestia</em> que habían caído luchando.
