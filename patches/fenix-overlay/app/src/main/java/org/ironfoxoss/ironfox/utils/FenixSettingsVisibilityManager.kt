...
object FenixSettingsVisibilityManager {
  ...
  fun SecretSettingsFragment(
    ...
    displayPreference(context, R.string.pref_key_enable_longfox, prefFragment)
    ...
    hidePreference(context, R.string.pref_key_enable_mozilla_ads_client, prefFragment)
