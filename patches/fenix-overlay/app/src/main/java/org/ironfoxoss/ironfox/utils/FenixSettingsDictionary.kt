...
object FenixSettingsDictionary {
    ...
    val enableHomepageSportsWidget = R.string.pref_key_enable_homepage_sports_widget
    ...
    val importBookmarksFeatureFlagEnabled = R.string.pref_key_enable_import_bookmarks
    ...
    val isIPProtectionEnabled = R.string.pref_key_enable_ip_protection
    ...
    val shouldShowTrackingProtectionDashboard = R.string.pref_key_tracking_protection_dashboard_status
