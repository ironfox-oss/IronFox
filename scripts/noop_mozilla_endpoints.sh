...
noop_mozilla_endpoints "firefox.settings.services.allizom.org" "${application_services}/components/external/glean"
...
noop_mozilla_endpoints "firefox.settings.services.mozilla.com" "${application_services}/components/external/glean"
...
noop_mozilla_endpoints "mozilla-ohttp.fastly-edge.com" "${application_services}/components/external/glean"
...
noop_mozilla_endpoints "prod.ohttp-gateway.prod.webservices.mozgcp.net" "${application_services}/components/external/glean"
