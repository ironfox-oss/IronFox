...
"${IRONFOX_SED}" -i -e "s|ext.androidCompileSdk = .*|ext.androidCompileSdk = '${ANDROID_SDK}'|g" build.gradle
...
"${IRONFOX_SED}" -i -e "s|ext.androidTargetSdk = .*|ext.androidTargetSdk = '${ANDROID_SDK}'|g" build.gradle
