...
readonly IRONFOX_PREBUILDS_PATCH="${IRONFOX_PATCH}"
...
export IRONFOX_PREBUILDS_PATCH
...
readonly PHOENIX_CAT="${IRONFOX_CAT}"
readonly PHOENIX_CHMOD="${IRONFOX_CHMOD}"
readonly PHOENIX_CP="${IRONFOX_CP}"
readonly PHOENIX_CURL="${IRONFOX_CURL}"
readonly PHOENIX_CURL_FLAGS="${IRONFOX_CURL_FLAGS}"
readonly PHOENIX_CURL_FLAGS_OVERRIDE=1
readonly PHOENIX_DATE="${IRONFOX_DATE}"
readonly PHOENIX_DIRNAME="${IRONFOX_DIRNAME}"
readonly PHOENIX_DOT_CLEAN="${IRONFOX_DOT_CLEAN}"
readonly PHOENIX_ECHO="${IRONFOX_ECHO}"
...
readonly PHOENIX_FIND="${IRONFOX_FIND}"
readonly PHOENIX_FORCE_RESET_REMOTE_DEBUGGING=0
readonly PHOENIX_GIT="${IRONFOX_GIT}"
readonly PHOENIX_GREP="${IRONFOX_GREP}"
readonly PHOENIX_GZIP="${IRONFOX_GZIP}"
readonly PHOENIX_HEAD="${IRONFOX_HEAD}"
readonly PHOENIX_JQ="${IRONFOX_JQ}"
readonly PHOENIX_LN="${IRONFOX_LN}"
readonly PHOENIX_LS="${IRONFOX_LS}"
readonly PHOENIX_MD5SUM="${IRONFOX_MD5SUM}"
readonly PHOENIX_MKDIR="${IRONFOX_MKDIR}"
readonly PHOENIX_NONTLS13_CIPHERS="${IRONFOX_NONTLS13_CIPHERS}"
...
readonly PHOENIX_RM="${IRONFOX_RM}"
readonly PHOENIX_SED="${IRONFOX_SED}"
readonly PHOENIX_SHA1SUM="${IRONFOX_SHA1SUM}"
readonly PHOENIX_SHA256SUM="${IRONFOX_SHA256SUM}"
readonly PHOENIX_SHA512SUM="${IRONFOX_SHA512SUM}"
readonly PHOENIX_STATIC_JS_ANDROID=0
readonly PHOENIX_TAR="${IRONFOX_TAR}"
readonly PHOENIX_TEE="${IRONFOX_TEE}"
